  ...
  return (
    <div className='hero-background justify-between lg:justify-start w-full flex flex-col items-center pt-32 lg:pt-40 pb-20 lg:pb-4'>
      <div className='flex flex-col items-center'>
        ...
        <a href='https://www.loom.com/share/8c89b40783c8416a9bbf3cdd97719b9a?sid=90b47d7f-f2ea-457d-8d25-cd284dbf036a' target="_blank" className='btn-gradient rounded-[4.5px] text-base text-white exo-2-bold px-[52px] py-3 md:py-4'>Watch Demo</a>
      </div>
